/* a function named string_concat() which will take two strings A and B as parameters and make
concatenation of A and B into A without using any library function i.e. strcat*/
#include<stdio.h>
